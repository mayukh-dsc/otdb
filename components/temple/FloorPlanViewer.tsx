    ...
    return (
      <div className="text-center py-16">
        ...
        <p className="text-sm text-stone-400 mt-1 max-w-md mx-auto">
          ...
          architectural drawings of this temple. Floor plans are available for
          ~30-50 well-documented heritage sites.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {images.map((img, i) => (
        ...
        >
          <div className="p-4 flex items-center justify-between bg-stone-50 border-b border-stone-200">
